"use client";
import { FormEvent, ReactHTMLElement, useState,useEffect, ReactElement } from "react";
    ...
    <div className="flex justify-center items-center">
      <main className="  text-slate-50 flex flex-col items-center justify-center p-8 overflow-hidden relative min-h-screen min-w-screen bg-gradient-to-r from-gray-800 to-zinc-900">
        ...
        <header className="text-center -mt-4 mb-5">
          <h1 className="text-2xl mb-4">BUG<span className="text-blue-500 tracking-tight">COST</span></h1>
          <p className="text-sm text-zinc-400 tracking-widest uppercase">Avaliação do arquivo</p>
        </header>
        <form onSubmit={Calcular}>
         <div className="space-y-2 grid grid-row-2">
          ...
          <label className="border border-dashed border-zinc-600 p-10 flex flex-col justify-center items-center rounded-2xl mt-4 mb-4 cursor-pointer hover:border-zinc-300 duration-400 transition-colors">
            ...
            <span className="">{arquivo ? arquivo.name : "Selecione o arquivo .log"}</span>
            <input
            type="file"
            className="hidden"
          ...
          <div className="flex justify-center items-center">
            <button type="submit" className=" bg-blue-950 rounded-xl p-3 w-50 tracking-wide flex justify-center items-center gap-4 mt-4 cursor-pointer hover:bg-blue-900 hover:scale-110 duration-300">
