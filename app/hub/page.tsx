...
import { Upload, ArrowRight, ArrowLeft, FileText } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-950 text-zinc-100 font-sans selection:bg-[#1f4693] selection:text-white overflow-x-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 relative z-10 w-full max-w-7xl mx-auto">
        <div className="w-full max-w-xl flex flex-col items-flex-start">
          <Link
            href="/"
            className="flex items-center gap-1.5 text-xs font-semibold text-zinc-400 hover:text-blue-500 transition-colors mb-3 ml-1"
          >
            <ArrowLeft size={20} />
          ...
          {/* CARD PRINCIPAL */}
          <div className="w-full p-5 sm:p-8 md:p-12 border border-zinc-800/80 rounded-2xl sm:rounded-3xl bg-zinc-900/80 backdrop-blur-xl shadow-2xl shadow-black/50 transition-all duration-300">
